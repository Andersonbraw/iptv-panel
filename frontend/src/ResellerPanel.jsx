      ...
      <main style={styles.main}>
        <div style={styles.topBar}>
          <div>
            ...
            <p style={styles.subtitle}>Crie clientes usando seus créditos.</p>
          </div>
        </div>
        ...
        <div style={styles.createBox}>
          ...
          <button style={styles.grayButton} onClick={loadDashboard}>
            Atualizar
          </button>
        </div>
        ...
        <div style={styles.statsGrid}>
          ...
          <div style={styles.cardGreen}>
            <h1>{clients.filter(c => c.status === 'active').length}</h1>
            <p>Ativos</p>
          </div>

          <div style={styles.cardRed}>
            <h1>{clients.filter(c => c.status === 'blocked').length}</h1>
            <p>Bloqueados</p>
          </div>
        </div>
        ...
        {clients.map(client => (
          <div key={client.id} style={styles.clientCard}>
            <div>
              ...
              <small>Plano: {client.plan || 'premium'} • Conexões: {client.max_connections || 1}</small>
              <br />
            ...
            <div style={styles.actions}>
              ...
              <button style={styles.redButtonSmall} onClick={() => updateClient(client, { status: 'blocked' })}>
                Bloquear
              </button>
              ...
              <button style={styles.deleteButton} onClick={() => deleteClient(client)}>
                Excluir
              </button>
            </div>
          </div>
...
const styles = {
  ...
  userBox: {
    background: 'linear-gradient(180deg,#09152f,#071127)',
    padding: 20,
    borderRadius: 24,
    marginBottom: 25,
