  ...
  async function addCredits(reseller) {
    try {
      ...
      if (selectedReseller?.id === reseller.id) {
        setSelectedReseller({
          ...selectedReseller,
          credits: Number(selectedReseller.credits || 0) + Number(addAmount || 0)
        })
      }
    } catch (err) {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Crie revendedores, envie créditos e acompanhe clientes.</p>
        </div>
      </div>
          ...
          {resellers.map(reseller => (
            <div key={reseller.id} style={styles.card}>
              <div>
                ...
                <small>Créditos: {reseller.credits || 0}</small>
                <br />
                <small>Clientes: {reseller.clients_count || 0}</small>
                <br />
