    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Crie revendedores, envie créditos e acompanhe clientes, vendas e lucro.</p>
        </div>
      </div>
...
const styles = {
  ...
  createBox: { display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 },
